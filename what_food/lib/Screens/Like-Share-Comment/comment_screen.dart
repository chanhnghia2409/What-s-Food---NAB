...
import 'package:what_food/Models/comment.dart';
...
class _CommentsScreenState extends State<CommentsScreen> {
  ...
  _buildComment(Comment comment) {
    return FutureBuilder(
      future: AuthService.getUserWithId(comment.authorId),
        ...
        return ListTile(
          ...
          subtitle: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 6.0),
              Text(
                DateFormat.yMd().add_jm().format(comment.time),
              ),
            ],
          ),
        );
              ...
              return Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    Comment comment =
                        Comment.fromJson(snapshot.data.documents[index]);
